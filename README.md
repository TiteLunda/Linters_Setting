...
- [Live Demo Link](https://github.com/TiteLunda/Linters_Setting)
...
Use git clone command(https://github.com/TiteLunda/Linters_Setting.git) 
...
Feel free to check the [issues page](https://github.com/TiteLunda/Linters_Setting/issues).
